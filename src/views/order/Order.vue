    ...
    methods: {
        ...
        headerNavDisplay() {
            if (window.innerWidth < 576) {
                ...
                this.headerUl.classList.add('invisible', 'flex-column', 'align-items-end', 'o-vertical-menu');
                this.menuButton.classList.remove('d-none');
            } else {
                // this.headerNavbar.classList.remove('flex-column');
                this.headerUl.classList.remove('invisible', 'flex-column', 'align-items-end', 'o-vertical-menu');
